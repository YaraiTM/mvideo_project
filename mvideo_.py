...
age = st.slider('Выберите возраст (age)', int(data['Возраст'].min()), int(data['Возраст'].max()),35)
work_days = st.slider('Выберите количество дней (work_days)', 0, int(data['Количество больничных дней'].max()),2)
